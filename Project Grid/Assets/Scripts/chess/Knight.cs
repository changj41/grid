...
//				this.transform.FindChild("Human_MasterRig").gameObject.SetActive(false);
				if(!_gameControllerScript.Knight1IsCover && this.name == "Knight1")
				{
					_gameControllerScript.Knight1IsCover = true;
					this.GetComponentInChildren<TextMesh>().text = "Knight1\n(cover)";
					GameObject.Find("myinceasecard10").GetComponent<InceaseCard>().MindControlSelectStep--;
				}
				else if(!_gameControllerScript.Knight2IsCover && this.name == "Knight2")
				{
					_gameControllerScript.Knight2IsCover = true;
					this.GetComponentInChildren<TextMesh>().text = "Knight2\n(cover)";
					GameObject.Find("myinceasecard10").GetComponent<InceaseCard>().MindControlSelectStep--;
				}
			}
			...
			{
				Vector3 tmp = this.transform.position;
				if(_gameControllerScript.PreSelectedUnit == "Priest1" && _gameControllerScript.Knight1IsCover && this.name == "Knight1")
				{
				...
				else if(_gameControllerScript.PreSelectedUnit == "Priest1" && _gameControllerScript.Knight2IsCover && this.name == "Knight2")
				{
					this.transform.position = GameObject.Find("Priest1").transform.position;
					GameObject.Find("Priest1").transform.position = tmp;
					GameObject.Find("myinceasecard10").GetComponent<InceaseCard>().MindControlSelectStep--;
				...
				else if(_gameControllerScript.PreSelectedUnit == "Priest2" && _gameControllerScript.Knight1IsCover && this.name == "Knight1")
				{
				...
				else if(_gameControllerScript.PreSelectedUnit == "Priest2" && _gameControllerScript.Knight2IsCover && this.name == "Knight2")
				{
					this.transform.position = GameObject.Find("Priest2").transform.position;
					GameObject.Find("Priest2").transform.position = tmp;
					GameObject.Find("myinceasecard10").GetComponent<InceaseCard>().MindControlSelectStep--;
	...
	{
		if(_gameControllerScript.PioneersUsedTurnOn)
		{
...
//			this.transform.Find("Character").GetComponent<MeshRenderer>().enabled = false;
		...
		{
			GameObject.Find("myinceasecard14").GetComponent<InceaseCard>().CommanderSelect = true;
			_gameControllerScript.CommanderSelectTurnOn = true;
			GameObject.Find("myinceasecard14").GetComponent<UIButton>().defaultColor = new Color(225/255f,0/255f,0/255f,255/255f);
			GameObject.Find("myinceasecard14").GetComponent<InceaseCard>().CommanderCount--;
		}
		_gameControllerScript.SideEnd = true;
	}
	public void cannel()
