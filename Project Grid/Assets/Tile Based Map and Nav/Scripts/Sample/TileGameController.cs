...
public class TileGameController : TMNController 
{
	// ====================================================================================================================
	...
	public TileNode hoverNode = null;	// that that mouse is hovering over
	public TileNode prevNode = null;	// helper during movement
...
//		}
		Unit unitFab = my.GetComponent<Unit>();
		int tries = 0;
		TileNode node = null;
		while (node == null)
		{
			if (unitFab.CanStandOn(map[0], true))
			{
				node = map[0];
			}
			tries++;
